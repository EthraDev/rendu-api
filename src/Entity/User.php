...
#[ApiResource(
    operations: [
        ...
        new Patch(processor: UserPasswordHasherProcessor::class, security: "is_granted('ROLE_PATRON')", securityMessage: 'You are not allowed to edit this user'),
        new Delete(security: "is_granted('ROLE_PATRON')", securityMessage: 'You are not allowed to delete this user'),
    ],
